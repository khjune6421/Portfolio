...
public:
	...
	virtual int _PixelPipeline1() { return -1; } // 아직 기능 없음
	virtual int _PixelPipeline2() { return -1; } // 아직 기능 없음
	...
	// 고정 함수
	virtual VS_OUTPUT _TnL_VP(VDVECTOR iPos, VDCOLOR iColor, VDVECTOR normal);
