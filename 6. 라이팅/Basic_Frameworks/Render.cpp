...
int ObjLoad()
{
	...
	{
		{ -0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v0
		{  0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v1
		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v2

		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v3
		{  0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v4
		{  0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v5


		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v6
		{ -0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v7
		{ -0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v8

		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v9
		{ -0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v10
		{  0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v11


		{  0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v12
		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v13
		{  0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v14

		{  0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v15
		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v16
		{  0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v17


		{ -0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v18
		{ -0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v19
		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v20

		{ -0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v21
		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v22
		{ -0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v23


		{ -0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v24
		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v25
		{ -0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v26

		{ -0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v27
		{  0.5f, 0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v28
		{  0.5f, 0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v29


		{  0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v30
		{ -0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v31
		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v32

		{  0.5f,-0.5f, 0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v33
		{ -0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v34
		{  0.5f,-0.5f,-0.5f, VDCOLOR(1.0f, 1.0f, 1.0f, 1.0f) },		//v35
	};
...
void ObjDraw()
{
	if (g_pVertexBuffer)
	{
		...
		g_pVooDooDevice->DrawPrimitive(VDPT_TRIANGLELIST, 0, 16);
	}
}
