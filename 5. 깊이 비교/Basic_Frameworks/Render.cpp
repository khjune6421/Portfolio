...
int ObjLoad()
{
	...
	{
		//정면.  ( Face#0) : '노랑색' 
		{ -0.5f, 0.5f,-0.5f, 0xffffff00 },		//v0
		{  0.5f, 0.5f,-0.5f, 0xffffff00 },		//v1
		{ -0.5f,-0.5f,-0.5f, 0xffffff00 },		//v2
		//       ( Face#1)
		{ -0.5f,-0.5f,-0.5f, 0xffffff00 },		//v3
		{  0.5f, 0.5f,-0.5f, 0xffffff00 },		//v4
		{  0.5f,-0.5f,-0.5f, 0xffffff00 },		//v5

		//뒷면.  (Face#0) : '90% 흰색'
		{  0.5f, 0.5f, 0.5f, 0xfff0f0f0 },		//v6
		{ -0.5f, 0.5f, 0.5f, 0xfff0f0f0 },		//v7
		{ -0.5f,-0.5f, 0.5f, 0xfff0f0f0 },		//v8
		//		  (Face#1)
		{  0.5f, 0.5f, 0.5f, 0xfff0f0f0 },		//v9
		{ -0.5f,-0.5f, 0.5f, 0xfff0f0f0 },		//v10
		{  0.5f,-0.5f, 0.5f, 0xfff0f0f0 },		//v11


		// 우측면. (Face#0)  '밝은파랑'
		{  0.5f, 0.5f,-0.5f, 0xff00ffff },		//v12
		{  0.5f, 0.5f, 0.5f, 0xff00ffff },		//v13
		{  0.5f,-0.5f,-0.5f, 0xff00ffff },		//v14
		//			(Face#1)
		{  0.5f,-0.5f,-0.5f, 0xff00ffff },		//v15
		{  0.5f, 0.5f, 0.5f, 0xff00ffff },		//v16
		{  0.5f,-0.5f, 0.5f, 0xff00ffff },		//v17


		// 좌측면. (Face#0) '빨강'
		{ -0.5f, 0.5f, 0.5f, 0xffff0000 },		//v18
		{ -0.5f, 0.5f,-0.5f, 0xffff0000 },		//v19
		{ -0.5f,-0.5f,-0.5f, 0xffff0000 },		//v20
		//			(Face#1)
		{ -0.5f, 0.5f, 0.5f, 0xffff0000 },		//v21
		{ -0.5f,-0.5f,-0.5f, 0xffff0000 },		//v22
		{ -0.5f,-0.5f, 0.5f, 0xffff0000 },		//v23


		//상부.  ( Face#0)  '녹색'
		{ -0.5f, 0.5f, 0.5f, 0xff00ff00 },		//v24
		{  0.5f, 0.5f, 0.5f, 0xff00ff00 },		//v25
		{ -0.5f, 0.5f,-0.5f, 0xff00ff00 },		//v26
		//		 ( Face#1)
		{ -0.5f, 0.5f,-0.5f, 0xff00ff00 },		//v27
		{  0.5f, 0.5f, 0.5f, 0xff00ff00 },		//v28
		{  0.5f, 0.5f,-0.5f, 0xff00ff00 },		//v29


		//하부.  ( Face#0)  '보라'
		{  0.5f,-0.5f, 0.5f, 0xff8000f0 },		//v30
		{ -0.5f,-0.5f, 0.5f, 0xff8000f0 },		//v31
		{ -0.5f,-0.5f,-0.5f, 0xff8000f0 },		//v32
		//		 ( Face#1)
		{  0.5f,-0.5f, 0.5f, 0xff8000f0 },		//v33
		{ -0.5f,-0.5f,-0.5f, 0xff8000f0 },		//v34
		{  0.5f,-0.5f,-0.5f, 0xff8000f0 },		//v35
	};
